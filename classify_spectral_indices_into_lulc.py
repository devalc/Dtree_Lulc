...
# input path
inputpath = 'D:/Chinmay/Pune/Analysis_06_06_2018/NITK_RSGIS_20180824_154257/Outputs/LT05_L1TP_147047_19900318_20170131_01_T1.tar/'


# read spectral indices into numpy arrays
ndvidata = gdal.Open(inputpath+'LT5[147_047](1990-03-18_04-48)NDVI.TIF', GA_ReadOnly)
ndvi = np.array(ndvidata.GetRasterBand(1).ReadAsArray())
ndwidata = gdal.Open(inputpath+'LT5[147_047](1990-03-18_04-48)NDWI.TIF', GA_ReadOnly)
ndwi = np.array(ndwidata.GetRasterBand(1).ReadAsArray())
ndbidata = gdal.Open(inputpath+'LT5[147_047](1990-03-18_04-48)NDBI_01.TIF', GA_ReadOnly)
ndbi = np.array(ndbidata.GetRasterBand(1).ReadAsArray())
ndbaidata = gdal.Open(inputpath+'LT5[147_047](1990-03-18_04-48)NDBaI_01.TIF', GA_ReadOnly)
ndbai = np.array(ndbaidata.GetRasterBand(1).ReadAsArray())
mndwidata = gdal.Open(inputpath+'LT5[147_047](1990-03-18_04-48)MNDWI_01.TIF', GA_ReadOnly)
